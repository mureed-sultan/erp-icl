...
app.controller('productCtrl', function($scope, $http, $filter){
	...
	$scope.getProduct = function(){
		$(".se-pre-con").fadeIn("slow");
	     	...
	     	$http.get('/OPAL/getAllSetItem').success(function(data) {
	     	...
	     	$http.get('/OPAL/getAllComponentItem').success(function(data) {
...
//  	  var object = JSON.stringify($scope.newCfgProductComponent);
  	  var object = $scope.newCfgProductComponent;
		$.ajax({
			url: '/OPAL/searchProductComponent',
			type: 'post',
          'headers': {
...
//		var object = JSON.stringify($scope.lstProductComponent);
		...
		$.ajax({
            url: '/OPAL/addNewProductComponent',
            type: 'post',
            'headers': {
    			'Content-Type': 'application/json'
    		},
