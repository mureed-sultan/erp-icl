...
app.config(function ($routeProvider) {
	...
	$routeProvider.when('/View', {
		templateUrl: '/' + project_name + '/SOView',
...
$scope.searchSaleOrder = function(){
		...
		window.setTimeout(
		$scope.searchSaleOrder2, 10);
	};

			$scope.searchSaleOrder2 = function () {
...
//												!isEmpty(so.txtOrderapprovalDate)? $filter('date')(
//												new Date(
//													so.txtOrderapprovalDate),
//												'dd-MM-yy hh:mm a'):'',
