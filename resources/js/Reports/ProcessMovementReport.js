...
app.controller('rptCtrl', function($scope, $http, $sce) {
	...
	$scope.getProcessDetailReportProcessWise = function(id){
		...
		window.open(window.location.protocol+"//"+window.location.host+"/"+project_name+"/getProcessDetailReportProcessWise?ser_process_id="+$scope.ReportDTO.ser_Process_Id+
																		...
																		"&Report_name=ProcessDetail.jasper","_blank");
	...
	$scope.getProcessWithHeldReport = function(id){
...
//		$scope.ReportDTO.ser_product_quality_id=3;
		...
		window.open(window.location.protocol+"//"+window.location.host+"/"+project_name+"/getProcessDetailReportProcessWise?ser_process_id="+$scope.ReportDTO.ser_Process_Id+
																		...
																		"&dte_date_to="+$scope.ReportDTO.dte_date_to+
																		"&ser_product_quality_id="+$scope.ReportDTO.ser_product_quality_id+
																		"&Report_name=Withheld.jasper","_blank");
		 $(".se-pre-con").fadeOut("slow");
...
$scope.getDPRReport = function(id){
...
//		$scope.ReportDTO.ser_product_quality_id=2;
		$scope.ReportDTO.ser_Process_Id = 1;
		
		
		window.open(window.location.protocol+"//"+window.location.host+"/"+project_name+"/getDPRReport?ser_process_id="+$scope.ReportDTO.ser_Process_Id+
																		"&txt_product_name="+$scope.ReportDTO.txt_product_name+
																		"&ser_product_category_id="+$scope.ReportDTO.ser_product_category_id+
																		"&ser_product_id="+$scope.ReportDTO.ser_product_id+
																		"&ser_product_design_id="+$scope.ReportDTO.ser_product_design_id+
