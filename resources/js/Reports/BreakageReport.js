...
app.controller('rptCtrl', function($scope, $http, $sce) {
	...
	$scope.getBreakgeReportProcessWise = function(id){
		...
		window.open(window.location.protocol+"//"+window.location.host+"/OPAL/getBreakgeReportProcessWise?ser_process_id="+$scope.ReportDTO.ser_Process_Id+
																		...
																		"&Report_name=breakage_report.jasper","_blank");
