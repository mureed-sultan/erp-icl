...
<body>
			...
			<div class="modal-content" style="width:900px">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						...
						>&times;</button>
					<modalTitle>Update Shipping for Bills</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="updateBill()"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										<select id="customerId" name="customerId" class="form-control input-md" ng-options="customerId.name for customerId in arrlist" ng-model="userselected"  ng-change="update(userSelect.id)"> 
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="noOfSeals" required="required" ng-minlength="1" ng-maxlength="50" 
											ng-model="citbill.numNoOfSeals" name="noOfSeals" type="text" ng-blur="getCalculate(citbill.numNoOfSeals)"
											class="form-control input-md requiredField">
									</div>
	...
	<script src="<c:url value="/resources/js/billing/billDetail.js"/>"></script>
