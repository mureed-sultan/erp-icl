...
<body>
			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="right_col" role="main">
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>Sale Order Summary Report (Online)</h2>
									</div>
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm_new" name="addGroupForm_new" ng-submit="getSaleDetailReportSummary()"
							...
							<fieldset>
												...
												<!-- 	<div class="form-group">
														...
														<div class="col-md-4">
															<select id="productId"
																ng-model="ReportDTO.ser_product_id"d
																 name="productId"
																class="form-control input-md requiredField"
																ng-options="filteredproduct.serProductId as filteredproduct.txtProductName for filteredproduct in lstProduct">
																<option ng-selected="selected" value="">--Select--</option>
															</select>
															<div role="alert">
													...
													<div class="form-group">
														...
														<div class="col-md-4 form-group">
															<input id="dateTo" readonly ng-model="ReportDTO.dte_date_to"
													...
													<div class="form-group">
															...
															<div class="col-md-7">
																<button type="" class="btn btn-primary" ng-click="downloadFile()">Generate Summary
																	Report</button>
																<a href="#" id="downloadLink" style="display: none;"
																	type="button" class="btn btn-success"
																	ng-click="downloadFile()">Download</a>
																<a  id="downloadLink" type="button" 
																	 class="btn btn-success" ng-click="getDCSummary_groupReportExcel()">Download CSV File</a>
															</div>
														</div>
												</fieldset>
						</form>
	...
	<script src="<c:url value="/resources/js/Reports/SOReport.js"/>"></script>
