...
<body>
			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="right_col" role="main">
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm_new" name="addGroupForm_new" ng-submit="getStockLedgerReportatWH(2)"
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<select id="editproductQualityId"
																...
																required name="editproductQualityId"
																class="form-control input-md requiredField" 
	...
	<script src="<c:url value="/resources/js/Reports/LedgerReport.js"/>"></script>
