...
<body>
			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="right_col" role="main">
					<div class="">
						...
						<div class="page-title">
							<div class="title_left">
								<h3>Sale Consolidated Report</h3>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>Sale Consolidated Report</h2>
									</div>
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm_new" name="addGroupForm_new" ng-submit="getConsolidatedSalesSummaryReport(5)"
	...
	<script src="<c:url value="/resources/js/Reports/SIReports.js"/>"></script>
