...
<body>
			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="right_col" role="main">
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm_new" name="addGroupForm_new" ng-submit="getWHIssuanceReport(5)"
	...
	<script src="<c:url value="/resources/js/Reports/WHReports.js"/>"></script>
