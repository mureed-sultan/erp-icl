...
<div class="container">
			...
			<div class="form-group row">
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm_new" name="addGroupForm_new" ng-submit="getSaleInvoiceListReport('all')"
															...
															<div class="col-md-7">
																...
																<a href="#" id="downloadLink" style="display: none;"
																	...
																	ng-click="downloadFile()">Download</a>
																	 ...
																	 class="btn btn-success" ng-click="generateAttendenceReportExcel('all')">Download CSV File</a>
															</div>
														</div>
												</fieldset>
						</form>
