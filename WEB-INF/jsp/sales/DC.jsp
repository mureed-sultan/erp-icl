										...
										<!-- 	<div class="form-group row">
											...
											<div class="form-group row">
												<label class="col-md-2 control-label" for="textinput">
													Sale Order: </label>
												<div class="col-md-4">
													<select class="form-control input-md" id="packing" ng-change="searchSaleOrderDetail()"
														ng-options="so as so.txtSaleOrderNo for so in lstSO"
														data-error="Please select Product" required="required"
														data-live-search="true"
														ng-model="newSlsTblSaleOrder">
														<option ng-selected="selected" value="">--Select--</option>
													</select>
												</div>
												...
												<div class="col-md-4">
													<input id="date" ng-model="newSlsTblSaleOrder.dteDate"
														name="date" type="text"
										...
										<thead>
											<tr class="headings">
												...
												<th class="column-title">Product</th>
															...
															<th class="column-title">MC Quantity</th>
										...
										<tbody>
											<tr ng-repeat="component in lstSODetails">
												...
												<td>{{component.cfgTblProduct.txtProductName}}</td>
															<td>{{component.cfgTblProductDesign.txtProductDesignName}}</td>
															<td>{{component.cfgTblProductQuality.txtProductQualityName}}</td>
															<td>{{component.cfgTblProduct.txtMasterPack}}</td>
															<td>{{component.numQuantity}}</td>
																<td><input 
																ng-model="component.numIssueQty" type="text"
																class="form-control input-md "></td>
															<td>{{component.numIssueQty*component.cfgTblProduct.numProductWeight}}</td>
...
<div>
	...
	<script src="<c:url value="/resources/js/Sales/DC.js"/>"></script>
