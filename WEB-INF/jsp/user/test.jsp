		                    ...
		                    <div class="col-md-4 form-group">
		                       ...
		                       <input type="file" name="uploadFile" id="uploadFile"  onchange="angular.element(this).scope().setFile(this)"  accept="image/*">
								...
								<div class="form-group">
									...
									<!-- ng-keydown="keydown1()" -->
									<label class="col-md-4 control-label" for="textinput">SSN:<span class="required">*</span>
									</label>
									<div class="col-md-6">
								...
								<div class="form-group">
								<label class="col-md-4 control-label" for="textinput">Password Policy:<span class="required">*</span>
									</label>
									<div class="col-md-6">
										<select class="form-control input-md selectpicker" ng-change=""
