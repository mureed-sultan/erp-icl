...
<body>
					...
					<div class="">
						...
						<div class="page-title">
							<div class="title_left">
								<h3>Paper Transfer Process Receiving</h3>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>Paper Transfer Process Receiving</h2>
									</div>
							  ...
							  <form class="form-inline" ng-submit="search()" style="padding:left:20px;">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												...
												<label class="col-md-2 control-label" for="productId">Date From:<span
												class="required">*</span>
											</label>

											<div class="col-md-6">
												<input id="dte_date_from" ng-model="searchDTO.dte_date_from" name="dte_date_from"
													type="text" tyle="width: 200px;"
													class="form-control input-md datepicker requiredField">
											</div>
											</div></b>
												<div class="form-group">
											<label class="col-md-2 control-label" for="productId">Date To:<span
												class="required">*</span>
											</label>

											<div class="col-md-6">
												<input id="dte_date_to" ng-model="searchDTO.dte_date_to" name="dte_date_to"
													type="text" tyle="width: 200px;"
													class="form-control input-md datepicker requiredField">
											</div>
	...
	<script src="<c:url value="/resources/js/Production/PT.js"/>"></script>
