		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Techno Process</modalTitle>
				</div>
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="PaperTransferProcessandAssignDesign()"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Product Code
										:<span class="required">*</span>
									</label>
									<div class="col-md-8">
									<input id="txtProductCode" required="required" readonly
											ng-model="editProductionSummary.cfgTblProduct.txtProductCode" name="txtProductCode"
											type="text" class="form-control input-md requiredField">
									</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Special Breakage Techno</modalTitle>
				</div>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------ -->
	...
	<script src="<c:url value="/resources/js/Production/TechnoProcess.js"/>"></script>
