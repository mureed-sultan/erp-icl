...
<body>
						...
						<form id="addGroupForm_new" name="addGroupForm_new" ng-submit="addProductionDetail()"
							...
							<div class="form-group">
									...
									<div class="col-md-4">
										...
										<label class="col-md-2 control-label" for="productId">Lehr:<span class="required">*</span>
									</label>
									
									<div class="col-md-4">
									<select id="layerId" ng-model="newProProductionDetailSetup.cfgTblLayer.serLayerId" required
											name="layerId" class="form-control input-md requiredField" 
											ng-options="filteredLaer.serLayerId as filteredLaer.txtLayerCode for filteredLaer in lstLayer">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
										<div role="alert">
											
												<span ng-show="addBranchForm.customerId.$error.required">Layer is required.</span> 
											</span>
										</div>
									</div>
									...
									<label class="col-md-2 control-label" for="textinput">Shift
										:<span class="required">*</span>
									</label>
									<div class="col-md-4">
									<select id="atype" ng-model="newProProductionDetailSetup.txtTime"
										...
										<!-- <input id="txtTime" required="required" ng-minlength="0"
											ng-maxlength="30"
											ng-model="newProProductionDetailSetup.txtTime" name="txtTime"
									...
									<label class="col-md-2 control-label" for="textinput" >Quantity in Gross
										 :<span class="required">*</span>
									</label>
									...
									<div class="col-md-4 ">
										<input id="Weight"  class="form-control input-md requiredField"
											name="Weight" type="text"
											ng-model="newProProductionDetailSetup.numUnitWt" required ng-pattern="patterns.integer">
										<div role="alert">
											<span style="color: red"
												ng-show="addGroupForm_new.yearBuilt1.$dirty  && addGroupForm_new.yearBuilt1.$invalid"> 
												<span ng-show="addGroupForm_new.yearBuilt1.$error.required">Quantity is required.</span> 
												<span class="error"
													ng-show="addGroupForm_new.yearBuilt1.$error.pattern">Only digits allowed. </span>
											</span>
										</div>
									</div>
								<!-- 	<div class="col-md-4">
										<input id="numProductWeight" name="numProductWeight" required="required" 
											ng-model="newProProductionDetailSetup.numUnitWt" name="itemName1"
											type="text" class="form-control input-md requiredField" ng-pattern="petterns.integer">
											<div role="alert">
											<span style="color: red"
												ng-show="addGroupForm_new.numProductWeight.$dirty  && addGroupForm_new.numProductWeight.$invalid"> 
												<span ng-show="addGroupForm_new.numProductWeight.$error.required">Product Weight is required.</span> 
												<span class="error"
													ng-show="addGroupForm_new.numProductWeight.$error.pattern">Only digits allowed. </span>
											</span>
										</div>
									</div> -->
						...
						<form id="addGroupForm" ng-submit="updateProductionDetail()"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
									<select id="editlayerId" ng-model="editProductionDetail.cfgTblLayer.serLayerId" required
											name="editlayerId" class="form-control input-md requiredField" 
											ng-options="filteredLaer.serLayerId as filteredLaer.txtLayerCode for filteredLaer in lstLayer">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
										<div role="alert">
								...
								<div class="form-group">
									...
									<select id="atype" ng-model="editProductionDetail.txtTime"
											name="atype" class="form-control input-md requiredField"
											required="required" ">
											<option value="">--Select--</option>
										<option value="Morning">Morning</option>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="editnumProductWeight" required="required" 
											ng-model="editProductionDetail.numUnitWt" name="edititemName1"
											type="text" class="form-control input-md requiredField">
									</div>
	...
	<script src="<c:url value="/resources/js/Production/PRC.js"/>"></script>
