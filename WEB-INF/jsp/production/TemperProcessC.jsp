		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Printing Process</modalTitle>
				</div>
						...
						<form id="addGroupForm" ng-submit="PaperTransferProcessandAssignDesign()"
							...
							<!-- 	<div class="form-group">
								...
								<label class="col-md-2 control-label" for="textinput"
										id="cname">Temper:<span class="required">*</span>
									</label>
									<div class="col-md-4">
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editProductionSummary.blIsTemper"
											class="form-control">
									</div>
									
									<label class="col-md-2 control-label" for="textinput"
										id="cname">Decorate:<span class="required">*</span>
									</label>
									<div class="col-md-4">
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editProductionSummary.blIsDecorated"
											class="form-control">
									</div>
							...
							<!-- 	<div class="form-group">
								...
								<div class="modal-footer">
									<div class="form-group">
										<div class="col-md-12">
											<div style="float: left;">
												<button type="button" id="editCloseButton2"
													class="btn btn-default" data-dismiss="modal" onclick="">Close</button>
											</div>
											<div style="float: right;">
												<input type="submit" value="Submit" class="btn btn-warning"/>
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Special Breakage Printing</modalTitle>
				</div>
...
<!-- ---------------------------------------------------------End of Special Breakage-------------------------------------------------------------- -->
	...
	<script src="<c:url value="/resources/js/Production/TemperProcessC.js"/>"></script>
