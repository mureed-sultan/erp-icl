		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Paper Transfer Process</modalTitle>
				</div>
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<select id="editproductDesignId" ng-model="editProductionSummary.cfgTblProductDesign.serProductDesignId" required 
										...
										<label class="col-md-4 control-label" for="productId">Contractor:<span
													class="required">*</span>
												</label>
												<div class="col-md-8">
													<select class="form-control input-md" id="packing"
														ng-options="supplier as supplier.txtSupplierName+ ' ' +supplier.txtSupplierCode for supplier in lstContractors"
														data-error="Please select Contrctor"
														data-live-search="true"
														ng-model="editProductionSummary.cfgTblSupplier">
														<option ng-selected="selected" value="">--Select--</option>
													</select>
												</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Special Breakage Paper Transfer</modalTitle>
				</div>
...
<div class="modal fade" id="TransferFormPT" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="TransferProducttoNextProcessFROMPaperTransferProcess()"
							class="form-horizontal">
							<fieldset>
							...
							<!-- 	<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
									<input id="txtProductDesignName" required="required"  readonly
											ng-model="editProductionSummary.cfgTblProductDesign.txtProductDesignName" name="txtProductDesignName"
											type="text" class="form-control input-md requiredField" >  
								...
								<div class="modal-footer">
									<div class="form-group">
										<div class="col-md-12">
											<div style="float: left;">
												<button type="button" id="editCloseButton_transfer"
													class="btn btn-default" data-dismiss="modal" onclick="">Close-Transfer</button>
											</div>
											<div style="float: right;">
												<input type="submit" value="Submit" class="btn btn-warning"/>
											</div>
						...
						<form id="addGroupForm" ng-submit="TransferProductQuality()"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<!-- <div class="col-md-4">
									<select id="qceditproductQualityId" ng-model="editProductionSummary.cfgTblProductQuality.serProductQualityId" required
											name="editproductQualityId" class="form-control input-md requiredField"  readonly
											ng-options="filteredproductQ.serProductQualityId as filteredproductQ.txtProductQualityName for filteredproductQ in lstProductQuality">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
									<select id="qceditproductQualityId_tr" ng-model="editProductionSummary.cfgTblProductQualityChange" required
											name="editproductQualityId_tr" class="form-control input-md requiredField"  
											ng-options="filteredproductQ as filteredproductQ.txtProductQualityName for filteredproductQ in lstProductQuality">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
										<div role="alert">
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------ -->
	...
	<script src="<c:url value="/resources/js/Production/PTProcess.js"/>"></script>
