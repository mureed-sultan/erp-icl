...
<script src="https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.4.8/angular-route.js"></script> -->
        ...
        <style>
            body {
                ...
                height: 100vh;
                background: radial-gradient(circle at center, #85C125, #020c3c 100%) center/cover no-repeat;
            }
        ...
        <script type="module">
            ...
            function init() {
                ...
                if (window.innerHeight <= 730) {
                    console.log("inner")
                    helper = new THREE.Mesh(new THREE.IcosahedronGeometry(200, 6), new THREE.MeshBasicMaterial({ color: 0xffffff, wireframe: true }));
                }else{
                    helper = new THREE.Mesh(new THREE.IcosahedronGeometry(400, 6), new THREE.MeshBasicMaterial({ color: 0xffffff, wireframe: true }));
                }
                group.add(helper);
