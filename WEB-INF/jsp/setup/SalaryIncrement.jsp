							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									...
									<div class="table-responsive " style="display: flex;">
                                        ...
                                        <table  id="data-table-1" class="table table-striped jambo_table bulk_action">
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" ng-model="checked1" ng-change="selectUnselectAll(1)" /></th>
                                                    <th>Sr. No.</th>
                                                    <th>Employee Name</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr ng-repeat="employee in employeeData">
                                                    <td><input type="checkbox" ng-model="employee.isSelected" ng-change="updateSecondTable(employee)" /></td>
                                                    <td>{{$index + 1}}</td>
                                                    <td>{{employee.txtEmployeeName}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        
                                            <table id="data-table-2" class="table table-striped jambo_table bulk_action">
                                                <thead>
                                                    <tr>
                                                        <th><input type="checkbox" ng-model="checked2" ng-change="selectUnselectAll(2)" /></th>
                                                        <th>Sr. No.</th>
                                                        <th>Employee Name</th>
                                                        <th>Action</th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="employee in selectedEmployees">
                                                        <td><input type="checkbox" ng-model="employee.isSelected" ng-change="updateFirstTable(employee)" /></td>
                                                        <td>{{$index + 1}}</td>
                                                        <td>{{employee.txtEmployeeName}}</td>
                                                        <td><i class="glyphicon glyphicon-remove" ng-click="removeFromSecondTable(employee)"></i></td>
                                                    </tr>
                                                </tbody>
                                            </table>
										...
										<!-- <table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Shift Code</th>
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addEmployee()"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<label class="control-label" for="textinput">Designation:<span
											class="required">*</span>
										</label> <input type="text" name="code"
											class="form-control input-md requiredField"
											ng-model="newHrEmployeeSetup.txtCnic">
							...
							<div class="form-group">
								<div class="col-md-12">
									<label class="control-label" for="textinput">Site:
									</label>
                            ...
                            <div class="form-group">
								<div class="col-md-12">
									<label class="control-label" for="textinput">Employee:
									</label>
