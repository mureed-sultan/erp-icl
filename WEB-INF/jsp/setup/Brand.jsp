...
<body>
	...
	<div class="wrapper" ng-controller="brandCtrl"
		data-ng-init="init()">
		<div class="box">
	...
	<div class="modal fade" id="addBrandForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addBrand()"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Brand 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemCode1" required="required"
											ng-model="newCfgBrandSetup.txtBrandCode" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">Brand
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"  
											ng-model="newCfgBrandSetup.txtBrandName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<textarea rows="6" cols="100" id="refNotes"
											ng-model="newCfgBrandSetup.txtDescription" name="refNotes" style="border: 1px solid"
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editBrandForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateBrand()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"  readonly
											ng-model="editBrand.txtBrandCode" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">Brand
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editBrand.txtBrandName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<textarea rows="6" cols="100" id="refNotes"
											ng-model="editBrand.txtDescription" name="refNotes" style="border: 1px solid"
											class="form-control input-md" placeholder="Enter Reference Notes"></textarea>
	...
	<script src="<c:url value="/resources/js/Setup/Brand.js"/>"></script>
