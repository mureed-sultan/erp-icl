...
<body>
	...
	<div class="wrapper" ng-controller="countryCtrl"
		data-ng-init="init()">
		<div class="box">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<!-- <th class="column-title">Country Code</th> -->
	...
	<div class="modal fade" id="addCountryForm" tabindex="-1" role="dialog"
		aria-labelledby="addCountry">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Country</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addCountry()"
							...
							<!-- 	<div class="form-group">
									<label class="control-label" for="textinput">Country 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-6">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newCfgCountrySetup.txtCountryCode" name="itemCode1" type="text"
								...
								<label class="control-label" for="textinput">Country
										...
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newCfgCountrySetup.txtName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editCountryForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateCountry()"
							class="form-horizontal">
							<fieldset>
                              ...
                              <label class="control-label" for="textinput">Country
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editCountry.txtName" name="itemName"
								...
								<label class="control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editCountry.blnStatus"
											class="form-control">
									</div>
								</div>
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/Country.js"/>"></script>
