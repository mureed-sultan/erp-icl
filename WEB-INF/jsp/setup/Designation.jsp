...
<body>
	...
	<div class="wrapper" ng-controller="designationCtrl"
		data-ng-init="init()">
		<div class="box">
									...
									<div>
										<div class="form-group">
											<button id="addNewEntry" data-loading-text="Processing..."
												...
												data-target="#addDesignationForm">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Designation Code</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Designation(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addDesignationForm" tabindex="-1" role="dialog"
		aria-labelledby="addDesignation">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Designation</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addDesignation()"
							...
							<fieldset>
									...
									<label class="col-md-2 control-label" for="textinput">Zone
									 ...
									 <div class="col-md-4 form-group">
										<select class="form-control input-md" ng-change=""
											...
											ng-model="newHrAreaSetup.citZoneSetup.txtZoneCode">
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Designation 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newHrDesignationSetup.txtDesignationCode" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">Designation
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newHrDesignationSetup.txtDesignationName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editDesignationForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Designation</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateDesignation()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"  ng-minlength="4" ng-maxlength="30" readonly
											ng-model="editDesignation.txtDesignationCode" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">Designation
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editDesignation.txtDesignationName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="col-md-2 control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editDesignation.blnStatus"
											class="form-control">
									</div>
								</div>
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/Designation.js"/>"></script>
