...
<style>
    ...
    .table-earning, .table-earning-list{
    ...
    .table-deduction, .deduction-list{
        grid-column: 4/span 2;
    }
    .ot{
        grid-column: 1/span 2;
								...
								<div class="x_panel">
									...
									<div class="table-responsive">
                                        ...
                                        <div class="grid-container">
                                            <div class="header text-center">Ahmad Vegetable Oil and Ghee Mills Limited</div>
                                            <div class="logo-item"><img src="resources/img/logo.png" alt="Logo"></div>
                                            <div class="slip-date">Pay Slip November 2023</div>
                                            <div class="employee-name">Employee Name</div>
                                            <div class="col-span-multi"></div>
                                            <div class="employee-designation">Designation</div>
                                            <div class="account-no">A/C</div>
                                            <div class="bank-name">BANK <br> MCB</div>
                                            <div class="table-earning text-center">Earning</div>
                                            <div class="table-deduction text-center">Deduction</div>
                                            <div class="table-earning-list">
												<ul>
													<li>Basic</li>
													<li>Hourse Rent </li>
													<li>Conveyance</li>
                                            ...
                                            <div class="ot">OT</div>
                                            <div class="total-deduction">Total Deduction</div>
                                            <div class="netsalary">Net Salary</div>
