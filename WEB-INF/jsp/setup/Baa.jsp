...
<body>
	...
	<div class="wrapper" ng-controller="baaCtrl"
		data-ng-init="init()">
		<div class="box">
	...
	<div class="modal fade" id="addBaaForm" tabindex="-1" role="dialog"
		aria-labelledby="addBaa">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Baa</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addBaa()"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="itemCode1" required="required"  
											ng-model="baaSetup.baaName" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">
									...
									<div class="col-md-6">
										<input id="itemName1" 
											ng-model="baaSetup.baaDescription" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editBaaForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Baa</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateBaa()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"   
											ng-model="editBaa.baaName" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">
									...
									<div class="col-md-8">
										<input id="itemName"  ng-maxlength="50"
											ng-model="editBaa.baaDescription" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
	...
	<script src="<c:url value="/resources/js/Setup/Baa.js"/>"></script>
