										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Payment No</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Loan View</modalTitle>
				</div>
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addEmployee()"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-6">
                                        <label class="control-label" for="textinput">Date From:<span
											class="required">*</span>
                                    ...
                                    <div class="col-md-6">
                                        <label class="control-label" for="textinput">Date To:<span
											class="required">*</span>
										</label> <input type="date" name="code"
											class="form-control input-md requiredField"
											ng-model="newHrEmployeeSetup.txtCnic">
								...
								<div class="form-group">
									<div class="col-md-6">
										...
										<label class="control-label" for="textinput">Employee:<span
											class="required">*</span>
                                    ...
                                    <div class="col-md-6">
										...
										<label class="control-label" for="textinput">Site:<span
											class="required">*</span>
										</label> <input type="text" name="code"
											class="form-control input-md requiredField"
											ng-model="newHrEmployeeSetup.txtCnic">
