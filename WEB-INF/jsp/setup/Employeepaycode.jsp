										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Pay Code</th>
													<th class="column-title">Employee </th>
													<th class="column-title">PayRate.</th>
													<th class="column-title">Effective Form</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Add Employee Paycode</modalTitle>
				</div>
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<label class="control-label" for="textinput">Paycode:<span
											class="required">*</span>
										</label> <input type="text" name="code"
											class="form-control input-md requiredField"
