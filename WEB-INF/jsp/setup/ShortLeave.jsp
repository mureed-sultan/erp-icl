										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Applying Date</th>
													<th class="column-title">Date</th>
													<th class="column-title">From</th>
													<th class="column-title">To</th>
													<th class="column-title">ShortLeave Type</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Add Short Leave</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addEmployee()"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-6">
										...
										<label class="control-label" for="textinput">Applying Date:<span
											class="required">*</span>
							...
							<div class="form-group">
								<div class="col-md-6">
									<label class="control-label" for="textinput">From:
									</label>
									...
									<label class="control-label" for="textinput">To:
									</label>
                            ...
                            <div class="form-group">
								<div class="col-md-6">
									<label class="control-label" for="textinput">Short Leave Type:
									</label>
									
                                    <select name="" id="" class="form-control input-md requiredField">
                                        <option value="1">Sick</option>
                                        <option value="1">Urgent</option>
                                    </select>
								</div>
                                <div class="col-md-6" style="display: flex; flex-direction:row-reverse; justify-content: start;">
									<label class="control-label" for="textinput">Is Annual:
									</label>
