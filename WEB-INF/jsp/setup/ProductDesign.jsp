...
<body>
	...
	<div class="wrapper" ng-controller="productDesignCtrl"
		data-ng-init="init()">
		<div class="box">
									...
									<div>
										<div class="form-group">
											<button id="addNewEntry" data-loading-text="Processing..."
												...
												data-target="#addProductDesignForm">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">ProductDesign Code</th>
													<th class="column-title">ProductDesign Name</th>
													<th class="column-title">Design Type</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected ProductDesign(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addProductDesignForm" tabindex="-1" role="dialog"
		aria-labelledby="addProductDesign">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add ProductDesign</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addProductDesign()"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="radio-inline"> <input type="radio" ng-model="newCfgProductDesignSetup.txtTypeName"
										value="Logo" name="optradio" checked>Logo
									</label> <label class="radio-inline"> <input type="radio" ng-model="newCfgProductDesignSetup.txtTypeName"
										value="Print" name="optradio">Print
									</label> <label class="radio-inline"> <input type="radio" ng-model="newCfgProductDesignSetup.txtTypeName"
										value="Color" name="optradio">Color
									</label>
								</div>
								
								{{newCfgProductDesignSetup.txtTypeName}}
							<!-- 
								<div class="btn-group">
								    <label class="radio-inlin" ng-model="newCfgProductDesignSetup.txtTypeName" btn-radio="'Logo'">Logo</label>
								    <label class="radio-inlin" ng-model="newCfgProductDesignSetup.txtTypeName" btn-radio="'Print'">Print</label>
								    <label class="radio-inlin" ng-model="newCfgProductDesignSetup.txtTypeName" btn-radio="'Color'">Color</label>
								</div> -->

                      			
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">ProductDesign 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemCode1" required="required"  
											ng-model="newCfgProductDesignSetup.txtProductDesignCode" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">ProductDesign
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"   ng-minlength="2" ng-maxlength="50"
											ng-model="newCfgProductDesignSetup.txtProductDesignName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<textarea rows="6" cols="100" id="refNotes"
											ng-model="newCfgProductDesignSetup.txtDescription" name="refNotes" style="border: 1px solid"
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editProductDesignForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit ProductDesign</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateProductDesign()"
							class="form-horizontal">
							<fieldset>

								<div class="form-group">
									<label class="radio-inline"> <input type="radio" ng-model="editProductDesign.txtTypeName"
										value="Logo" name="optradio" checked>Logo
									</label> <label class="radio-inline"> <input type="radio" ng-model="editProductDesign.txtTypeName"
										value="Print" name="optradio">Print
									</label> <label class="radio-inline"> <input type="radio" ng-model="editProductDesign.txtTypeName"
										value="Color" name="optradio">Color
									</label>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"   readonly
											ng-model="editProductDesign.txtProductDesignCode" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">ProductDesign
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editProductDesign.txtProductDesignName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="col-md-2 control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editProductDesign.blnStatus"
											class="form-control">
									</div>
								</div>
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<textarea rows="6" cols="100" id="refNotes"
											ng-model="editProductDesign.txtDescription" name="refNotes" style="border: 1px solid"
											class="form-control input-md" placeholder="Enter Reference Notes"></textarea>
	...
	<script src="<c:url value="/resources/js/Setup/ProductDesign.js"/>"></script>
