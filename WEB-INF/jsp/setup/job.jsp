...
<body>
	...
	<div class="wrapper" ng-controller="jobCtrl"
		data-ng-init="init()">
		<div class="box">
	...
	<div class="modal fade" id="addRecordForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Add Job</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addRecord()"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Job 
										Name:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newRecordSetup.txtJobName" name="itemCode1" type="text"
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Rate:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="rateField" required="required" 
											ng-model="newRecordSetup.rate" name="itemCode1" type="text"
											class="form-control input-md requiredField" >
									</div>
									<!-- <br/> -->
  								</div>
  								  ...
  								  <!--  ratePerHour -->
  								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Per Hour Rate:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="rateField" required="required" 
											ng-model="newRecordSetup.rate/8" name="itemCode1" type="text"
											class="form-control input-md requiredField" >
									</div>
									<!-- <br/> -->
  								</div>
                                ...
                                <div class="form-group">
								<label class="col-md-4 control-label" for="textinput">Description:<span class="required">*</span> </label>
									<div class="col-md-4">
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newRecordSetup.txtDescription" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="newRecordSetup.blnStatus"
											class="form-control">
									</div>
								 </div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editRecordForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="UpdateRecord()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"  ng-minlength="4" ng-maxlength="30" readonly
											ng-model="editRecord.txtJobName" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">Rate:<span class="required">*</span>
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editRecord.rate" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
 								</div>
 								...
 								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="rateField" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="editRecord.rate/8" name="itemCode1" type="text"
											class="form-control input-md requiredField" >
									</div>
									<!-- <br/> -->
  								</div>
 							 ...
 							 <div class="form-group">
                              <label class="col-md-4 control-label" for="textinput">Description:<span class="required">*</span>
									</label>
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editRecord.txtDescription" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
 								</div>
	...
	<script src="<c:url value="/resources/js/Setup/Job.js"/>"></script>
