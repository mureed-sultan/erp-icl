...
<body>
	...
	<div class="wrapper" ng-controller="supplierCategoryCtrl"
		data-ng-init="init()">
		<div class="box">
									...
									<div>
										<div class="form-group">
											<button id="addNewEntry" data-loading-text="Processing..."
												...
												data-target="#addSupplierCategoryForm">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">SupplierCategory Code</th>
													<th class="column-title">SupplierCategory Name</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected SupplierCategory(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addSupplierCategoryForm" tabindex="-1" role="dialog"
		aria-labelledby="addSupplierCategory">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add SupplierCategory</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addSupplierCategory()"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">SupplierCategory 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemCode1" required="required"  
											ng-model="newCfgSupplierCategorySetup.txtSupplierCategoryCode" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">SupplierCategory
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"   
											ng-model="newCfgSupplierCategorySetup.txtSupplierCategoryName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<textarea rows="6" cols="100" id="refNotes"
											ng-model="newCfgSupplierCategorySetup.txtDescription" name="refNotes" style="border: 1px solid"
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editSupplierCategoryForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit SupplierCategory</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateSupplierCategory()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"   readonly
											ng-model="editSupplierCategory.txtSupplierCategoryCode" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">SupplierCategory
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editSupplierCategory.txtSupplierCategoryName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="col-md-2 control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editSupplierCategory.blnStatus"
											class="form-control">
									</div>
								</div>
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<textarea rows="6" cols="100" id="refNotes"
											ng-model="editSupplierCategory.txtDescription" name="refNotes" style="border: 1px solid"
											class="form-control input-md" placeholder="Enter Reference Notes"></textarea>
	...
	<script src="<c:url value="/resources/js/Setup/SupplierCategory.js"/>"></script>
