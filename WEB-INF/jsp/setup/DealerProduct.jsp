									...
									<form ng-submit="addProduct()">
										<fieldset>
											<div class="form-group row">
												...
												<div class="col-md-4">
													<select class="form-control input-md" id="product" ng-change="showRecipe()"
														ng-options="product as product.txtCustomerName for product in lstCustomer"
														data-error="Please select Product" required="required"
														data-live-search="true"  
														ng-model="newCfgProductComponent.cfgTblCustomer">
														<option ng-selected="selected" value="">--Select--</option>
													</select>
												</div>
												<div> <button type="button" id="ldButton" class="btn btn-primary" type="submit"
											...
											<button type="button" class="btn btn-primary" type="submit"
												...
												<i class="glyphicon glyphicon-plus-sign"></i>Delete Product
											</button>
									...
									<table ng-table="user-table" id="data-table"
										...
										<tbody>
											<tr ng-repeat="component in lstProductComponent">
												...
												<td>{{component.cfgTblCustomer.txtCustomerName}}</td>
...
<div>
									 <div class="form-group">
										<button id="addNewEntry" type="submit" class="btn btn-success" style="float:right">
											<i class="glyphicon glyphicon-plus-sign"></i>&nbsp;Save Dealer Products
										</button>
	...
	<script src="<c:url value="/resources/js/Setup/DealerProduct.js"/>"></script>
