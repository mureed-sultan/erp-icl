...
<body>
	...
	<div class="wrapper" ng-controller="incoTermCtrl"
		data-ng-init="init()">
		<div class="box">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<!-- <th class="column-title">IncoTerm Code</th> -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Inco Term(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addIncoTermForm" tabindex="-1" role="dialog"
		aria-labelledby="addIncoTerm">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Inco Terms</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addIncoTerm()"
							...
							<!-- 	<div class="form-group">
									<label class="control-label" for="textinput">IncoTerm 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-6">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newCfgIncoTermSetup.txtIncoTermCode" name="itemCode1" type="text"
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="1" ng-maxlength="50"
											ng-model="newCfgIncoTermSetup.txtCode" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="1" ng-maxlength="50"
											ng-model="newCfgIncoTermSetup.txtName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editIncoTermForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Inco Terms</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateIncoTerm()"
							class="form-horizontal">
							<fieldset>
...
<div class="form-group">
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editIncoTerm.txtCode" name="itemName"
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editIncoTerm.txtName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editIncoTerm.blnStatus"
											class="form-control">
									</div>
								</div>
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/IncoTerm.js"/>"></script>
