...
<body>
	...
	<div class="wrapper" ng-controller="saleOrganizationCtrl"
		data-ng-init="init()">
		<div class="box">
									...
									<div>
										<div class="form-group">
											<button id="addNewEntry" data-loading-text="Processing..."
												...
												data-target="#addSalesOrganizationForm">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<!-- <th class="column-title">SalesOrganization Code</th> -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Sales Organization(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addSalesOrganizationForm" tabindex="-1" role="dialog"
		aria-labelledby="addSalesOrganization">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Sales Organization</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addSalesOrganization()"
							...
							<!-- 	<div class="form-group">
									<label class="control-label" for="textinput">SalesOrganization 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-6">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newCfgSalesOrganizationSetup.txtSalesOrganizationCode" name="itemCode1" type="text"
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="1" ng-maxlength="50"
											ng-model="newCfgSalesOrganizationSetup.txtCode" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="1" ng-maxlength="50"
											ng-model="newCfgSalesOrganizationSetup.txtName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editSalesOrganizationForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Sales Organization</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateSalesOrganization()"
							class="form-horizontal">
							<fieldset>
...
<div class="form-group">
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editSalesOrganization.txtCode" name="itemName"
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editSalesOrganization.txtName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editSalesOrganization.blnStatus"
											class="form-control">
									</div>
								</div>
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/SalesOrganization.js"/>"></script>
