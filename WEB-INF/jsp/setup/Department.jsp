...
<body>
	...
	<div class="wrapper" ng-controller="departmentCtrl"
		data-ng-init="init()">
		<div class="box">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Department(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addDepartmentForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addDepartment()"
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newHrDepartmentSetup.txtDepartmentCode" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">Department
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newHrDepartmentSetup.txtDepartmentName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
 	...
 	<div class="modal fade" id="editDepartmentForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateDepartment()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"  ng-minlength="4" ng-maxlength="30" readonly
											ng-model="editDepartment.txtDepartmentCode" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">Department
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editDepartment.txtDepartmentName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="col-md-2 control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editDepartment.blnStatus"
											class="form-control">
									</div>
								</div>
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/Department.js"/>"></script>
