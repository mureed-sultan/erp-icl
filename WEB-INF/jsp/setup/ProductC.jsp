...
<body>
						...
						<form id="addGroupForm" name="addGroupForm" ng-submit="addProduct()"
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="txtProductCode" required="required" 
											ng-model="newCfgProductSetup.txtProductCode" name="txtProductCode"
									...
									<div class="col-md-4">
										<input id="txtProductName" required="required" 
											ng-model="newCfgProductSetup.txtProductName" name="txtProductName"
											type="text" class="form-control input-md requiredField">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="txtMasterPack" required="required" ng-minlength="0"
											ng-maxlength="50"
											ng-model="newCfgProductSetup.txtMasterPack" name="txtMasterPack"
											type="text" class="form-control input-md requiredField">
									</div>
									...
									<div class="col-md-4">
										<input id="numProductWeight" required="required" 
											ng-model="newCfgProductSetup.numProductWeight" name="numProductWeight"
											type="text" class="form-control input-md requiredField">
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-md-2 control-label" for="textinput">Pieces
										in Pallet:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="numPiecesInMasterPack" required="required" 
											ng-model="newCfgProductSetup.numPiecesInMasterPack" name="numPiecesInMasterPack"
											type="text" class="form-control input-md requiredField">
									</div>
									
										<label class="col-md-2 control-label" for="textinput">Units
										in Pallet:<span class="required">*</span>
									</label>
									<div class="col-md-4">
								
										<input id="numUnitsInMasterPack" required="required" 
											ng-model="newCfgProductSetup.numUnitsInMasterPack" name="numUnitsInMasterPack"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select id="atype" ng-model="newCfgProductSetup.txtPriceUnit"
											name="atype" class="form-control input-md requiredField"
											required="required" ">
									...
									<div class="col-md-4">
										<input id="numSalePrice" required="required" 
											ng-model="newCfgProductSetup.numSalePrice" name="numSalePrice"
											type="text" class="form-control input-md requiredField">
									</div>
							...
							>
									...
									<label class="col-md-2 control-label" for="textinput"
										id="cname">Import:<span class="required">*</span>
									</label>
									<div class="col-md-4">
									<input type="checkbox" id="empstatImport" name="empstatImport"
											 ng-model="newCfgProductSetup.blIsImport"
											class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<label class="col-md-2 control-label" for="textinput"
										id="isSet">Set:<span class="required">*</span>
									</label>
									<div class="col-md-4">
									<input type="checkbox" id="empisset" name="empisset"
											 ng-model="newCfgProductSetup.blIsSet"
											class="form-control">
									</div>
									
									<label class="col-md-2 control-label" for="textinput"
										id="cname">Sale:<span class="required">*</span>
									</label>
									<div class="col-md-4">
									<input type="checkbox" id="empisSale" name="empisSale"
											 ng-model="newCfgProductSetup.blnIsSaleItem"
											class="form-control">
									</div>
									
									<label class="col-md-2 control-label" for="textinput"
										id="cname">Production:<span class="required">*</span>
									</label>
									<div class="col-md-4">
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="newCfgProductSetup.blIsProduction"
											class="form-control">
									</div>
									
									<label class="col-md-2 control-label" for="textinput"
										id="cname">Component:<span class="required">*</span>
									</label>
									<div class="col-md-4">
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="newCfgProductSetup.blIsComponent"
											class="form-control">
									</div>
						...
						<form id="addGroupForm" ng-submit="updateProduct()"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="edittxtProductCode" required="required" 
											ng-model="editProduct.txtProductCode" name="edittxtProductCode"
											type="text" class="form-control input-md requiredField">
									</div>
									...
									<div class="col-md-4">
										<input id="edittxtProductName" required="required" 
											ng-model="editProduct.txtProductName" name="edittxtProductName"
											type="text" class="form-control input-md requiredField">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="edittxtMasterPack" required="required" ng-minlength="0"
											ng-maxlength="50"
											ng-model="editProduct.txtMasterPack" name="edittxtMasterPack"
											type="text" class="form-control input-md requiredField">
									</div>
									...
									<div class="col-md-4">
										<input id="editnumProductWeight" required="required" 
											ng-model="editProduct.numProductWeight" name="editnumProductWeight"
											type="text" class="form-control input-md requiredField">
									</div>
								</div>
									...
									<div class="col-md-4">
										<input id="numPiecesInMasterPack" required="required" 
											ng-model="editProduct.numPiecesInMasterPack" name="numPiecesInMasterPack"
											type="text" class="form-control input-md requiredField">
									</div>
									...
									<div class="col-md-4">
										...
										<input id="numUnitsInMasterPack" required="required" 
											ng-model="editProduct.numUnitsInMasterPack" name="numUnitsInMasterPack"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
									<select id="edittxtPriceUnit" ng-model="editProduct.txtPriceUnit"
											name="edittxtPriceUnit" class="form-control input-md requiredField"
											required="required" >
											<option value="">--Select--</option>
											<option value="Gross">Gross</option>
											<option value="Piece">Piece</option>
									...
									<div class="col-md-4">
										<input id="editnumSalePrice" required="required" 
											ng-model="editProduct.numSalePrice" name="editnumSalePrice"
											type="text" class="form-control input-md requiredField">
									</div>
									...
									<div class="col-md-4">
										<input type="checkbox" id="empstat" name="empstat"
											ng-model="editProduct.blnStatus" class="form-control">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
									<input type="checkbox" id="empisSale" name="empisSale"
											 ng-model="editProduct.blnIsSaleItem"
											class="form-control">
									</div>
									...
									<div class="col-md-4">
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editProduct.blIsProduction"
											class="form-control">
									</div>
									...
									<div class="col-md-4">
									<input type="checkbox" id="editempstat" name="editempstat"
											 ng-model="editProduct.blIsComponent"
											class="form-control">
									</div>
									...
									<div class="col-md-4">
									<input type="checkbox" id="editstatImport" name="editstatImport"
											 ng-model="editProduct.blIsImport"
											class="form-control">
									</div>
	...
	<script src="<c:url value="/resources/js/Setup/ProductC.js"/>"></script>
