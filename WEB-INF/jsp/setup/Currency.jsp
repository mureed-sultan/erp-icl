...
<body>
	...
	<div class="wrapper" ng-controller="currencyCtrl"
		data-ng-init="init()">
		<div class="box">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Currency(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addCurrencyForm" tabindex="-1" role="dialog"
		aria-labelledby="addCurrency">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Currency</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addCurrency()"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Currency 
										Name:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemCode1" required="required" 
											ng-model="newCfgCurrencySetup.txtName" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">Currency
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"   
											ng-model="newCfgCurrencySetup.txtCurrencySign" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<input type="checkbox" id="empstat1pc" name="empstat1pc"
											 ng-model="newCfgCurrencySetup.isParentCurrency"
											class="form-control">
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editCurrencyForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Currency</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateCurrency()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="itemCode1" required="required"  
											ng-model="editCurrency.txtName" name="itemCode1" type="text"
											class="form-control input-md requiredField">
									</div>
									<!-- <br/> -->
								...
								<label class="col-md-4 control-label" for="textinput">Currency
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"   
											ng-model="editCurrency.txtCurrencySign" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<input type="checkbox" id="empstat1pc" name="empstat1pc"
											 ng-model="editCurrency.isParentCurrency"
											class="form-control">
								...
								<label class="col-md-2 control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editCurrency.blnStatus"
											class="form-control">
									</div>
								</div>
	...
	<script src="<c:url value="/resources/js/Setup/Currency.js"/>"></script>
