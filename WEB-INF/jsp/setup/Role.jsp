...
<body>
	...
	<div class="wrapper" ng-controller="roleCtrl"
		data-ng-init="init()">
		<div class="box">
	...
	<div class="modal fade" id="addRoleForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addRole()"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Role 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemCode1" required="required"  
											ng-model="newCfgRoleSetup.txtRoleCode" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">Role
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"   
											ng-model="newCfgRoleSetup.txtRoleName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editRoleForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateRole()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"   readonly
											ng-model="editRole.txtRoleCode" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">Role
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editRole.txtRoleName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
	...
	<script src="<c:url value="/resources/js/Setup/Role.js"/>"></script>
