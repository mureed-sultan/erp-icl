...
<body>
	...
	<div class="wrapper" ng-controller="paymentTermCtrl"
		data-ng-init="init()">
		<div class="box">
									...
									<div>
										<div class="form-group">
											<button id="addNewEntry" data-loading-text="Processing..."
												...
												data-target="#addPaymentTermForm">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<!-- <th class="column-title">payment Term Code</th> -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Payment Term(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addPaymentTermForm" tabindex="-1" role="dialog"
		aria-labelledby="addPaymentTerm">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Payment Term</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addPaymentTerm()"
							...
							<!-- 	<div class="form-group">
									<label class="control-label" for="textinput">PaymentTerm 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-6">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newCfgPaymentTermSetup.txtPaymentTermCode" name="itemCode1" type="text"
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="1" ng-maxlength="50"
											ng-model="newCfgPaymentTermSetup.txtCode" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="1" ng-maxlength="50"
											ng-model="newCfgPaymentTermSetup.txtName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editPaymentTermForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Payment Term</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updatePaymentTerm()"
							class="form-horizontal">
							<fieldset>
...
<div class="form-group">
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editPaymentTerm.txtCode" name="itemName"
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editPaymentTerm.txtName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editPaymentTerm.blnStatus"
											class="form-control">
									</div>
								</div>
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/PaymentTerm.js"/>"></script>
