...
<body>
	...
	<div class="wrapper" ng-controller="divisionCtrl"
		data-ng-init="init()">
		<div class="box">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<!-- <th class="column-title">Division Code</th> -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Division(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addDivisionForm" tabindex="-1" role="dialog"
		aria-labelledby="addDivision">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Division</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addDivision()"
							...
							<!-- 	<div class="form-group">
									...
									<div class="col-md-6">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newCfgDivisionSetup.txtDivisionCode" name="itemCode1" type="text"
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newCfgDivisionSetup.txtCode" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newCfgDivisionSetup.txtName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editDivisionForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Division</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateDivision()"
							class="form-horizontal">
							<fieldset>
...
<div class="form-group">
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editDivision.txtCode" name="itemName"
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editDivision.txtName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editDivision.blnStatus"
											class="form-control">
									</div>
								</div>
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/Division.js"/>"></script>
