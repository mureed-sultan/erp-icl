					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addEmployee()"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-12">
										<label class="control-label" for="textinput">Shift Code:<span class="required">*</span>
										</label> <select type="text" name="code"
											class="form-control input-md requiredField"
											ng-model="newHrEmployeeSetup.txtEmployeeCode">
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<label class="control-label" for="textinput">Shift Name:<span
											class="required">*</span>
							...
							<div class="form-group">
								<div class="col-md-12">
									<label class="control-label" for="textinput">Shift Day:
									</label>
                            ...
                            <div class="form-group">
								<div class="col-md-12">
									<label class="control-label" for="textinput">Delay Allow Per Day:
									</label>
                            ...
                            <div class="form-group">
								<div class="col-md-6">
									<label class="control-label" for="textinput">Effective Date:
									</label>
                                ...
                                <div class="col-md-6">
									<label class="control-label" for="textinput">Change Date:
									</label>
                             ...
                             <div class="form-group">
								<div class="col-md-6">
									<label class="control-label" for="textinput">Starting Time:
									</label>
