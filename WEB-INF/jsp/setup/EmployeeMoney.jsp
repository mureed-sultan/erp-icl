										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">From Loc </th>
													<th class="column-title">To Location</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Money Transfer</modalTitle>
				</div>
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<label class="control-label" for="textinput">Transfer Date:<span
											class="required">*</span>
                                ...
                                <div class="form-group">
									<div class="col-md-12">
										<label class="control-label" for="textinput">From Location:<span class="required">*</span>
										</label> <select name="" id="" class="form-control input-md requiredField">
                                            <option value="1">1</option>
                                        </select>
                                ...
                                <div class="form-group">
									<div class="col-md-12">
										<label class="control-label" for="textinput">To Location:<span class="required">*</span>
										</label> <select name="" id="" class="form-control input-md requiredField">
                                            <option value="1">1</option>
                                        </select>
