					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addEmployee()"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-6">
										<label class="control-label" for="textinput">Holiday Name:<span class="required">*</span>
								...
								<div class="form-group">
									<div class="col-md-6">
										...
										<label class="control-label" for="textinput">Description:<span
											class="required">*</span>
										</label> <input type="text" name="code"
											class="form-control input-md requiredField"
											>
