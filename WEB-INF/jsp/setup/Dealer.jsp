...
<div class="table-container" id="table-resp">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<!-- <th class="column-title">Dealer Code</th> -->
													<th class="column-title">Dealer Name</th>
													<th class="column-title">Sap No</th>
													<th class="column-title">Dealer Category</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Add Dealer</modalTitle>
				</div>
						...
						<form id="addGroupForm" name="addGroupForm"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-6">
										...
										<div role="alert">
											...
											<span ng-show="addBranchForm.customerId.$error.required">Dealer
												Category is required.</span> </span>
										</div>
									</div>
									<div class="col-md-6">
										<label class=" control-label" for="textinput">Dealer
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<label class="control-label" for="textinput">Area :<span
											...
											ng-model="newCfgCustomerSetup.cfgTblArea.serAreaId" 
								...
								<div class="col-md-6">
								 ...
								 <div class="col-md-6">
										<label class="control-label" for="textinput">Responsible Person :<span
											class="required"></span>
										</label> <select id="cityId"
                                 ...
                                 <div class="form-group">
									...
									<div class="col-md-2">
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="newCfgCustomerSetup.blIsGroup"
											class="form-control">
									</div>

									<!-- <div class="col-md-6">
									<label class="control-label" for="textinput">SAP No.:<span
										class="required">*</span>
									</label>
									
										<input id="txtSapNo" required="required"
											ng-model="newCfgCustomerSetup.txtSapNo" name="txtSapNo"
											type="text" class="form-control input-md requiredField">
									</div> -->
								</div>
								<div ng-if="newCfgCustomerSetup.blIsGroup ? false:true" class="form-group">
								<div class="col-md-6">
								...
								<div  class="col-md-6">
									...
									<div ng-if="newCfgCustomerSetup.blIsGroup ? true:false" class="form-group">
									<div class="col-md-6">
										<label class="control-label" for="customerId">Customer
											:<span class="required">*</span>
										</label> <select id="countryId"
											ng-model="newCfgCustomerSetup.cfgTblGroupCustomer.serCustomerId"
											required name="groupcustomerId"
											class="form-control input-md requiredField"
											ng-options="user.cfgTblCustomer.serCustomerId as user.txtUserName for user in lstUsers">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
								...
								<label class="col-md-4 control-label" for="textinput"
										id="cname">Labsa:<span class="required">*</span>
									</label>
									<div class="col-md-2">
									<input type="checkbox" id="blIsLabsa" name="blIsLabsa"
											 ng-model="newCfgCustomerSetup.blIsLabsa"
											class="form-control">
									</div>
 ...
 -->
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Dealer</modalTitle>
				</div>
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateCustomer()"
							...
							<fieldset>
								...
								<div class="form-group">
								  <div class="col-md-6">						
									<label class="control-label" for="customerId">Dealer Category:<span class="required">*</span>
									</label>
									
									
									<select id="editCustomer CategoryId" ng-model="editCustomer.cfgTblCustomerCategory.serCustomerCategoryId" required
											name="editCustomer CategoryId" class="form-control input-md requiredField" 
											ng-options="filteredCustomerCategory.serCustomerCategoryId as filteredCustomerCategory.txtCustomerCategoryName for filteredCustomerCategory in lstCustomerCategory">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
										<div role="alert">
											
												<span ng-show="addBranchForm.customerId.$error.required">Dealer Category is required.</span> 
											</span>
										</div>
									</div>
								...
								<div class="col-md-6">
									...
									<div class="col-md-6">
										<label class="control-label" for="textinput">City :<span
											...
											ng-model="editCustomer.cfgTblCity.serCityId" required
											name="cityId" class="form-control input-md requiredField"
											ng-options="filteredCity.serCityId as filteredCity.txtCityName for filteredCity in lstCity | orderBy:'txtCityName' ">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<label class="control-label" for="textinput">Area :<span
											...
											ng-model="editCustomer.cfgTblArea.serAreaId" 
											name="areaId" class="form-control input-md requiredField"
											ng-options="filteredArea.serAreaId as filteredArea.txtAreaName for filteredArea in lstArea | orderBy:'txtAreaName' ">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
								...
								<div class="col-md-6">
								 ...
								 <div class="col-md-6">
									...
									<div ng-if="editCustomer.blIsGroup ? false:true" class="form-group">
								<div class="col-md-6">
									<label class="control-label" for="textinput">Email.:<span
										class="required">*</span>
									</label>
	...
	<script src="<c:url value="/resources/js/Setup/Dealer.js"/>"></script>
