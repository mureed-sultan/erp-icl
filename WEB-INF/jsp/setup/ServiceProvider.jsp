...
<body>
	...
	<div class="wrapper" ng-controller="serviceProviderCtrl"
		data-ng-init="init()">
		<div class="box">
									...
									<div>
										<div class="form-group">
											<button id="addNewEntry" data-loading-text="Processing..."
												...
												data-target="#addServiceProviderForm">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected ServiceProvider(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addServiceProviderForm" tabindex="-1" role="dialog"
		aria-labelledby="addServiceProvider">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Service Providerid</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addServiceProvider()"
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="itemCode1" required="required"  
											ng-model="serviceProviderSetup.serviceProviderName" name="itemCode1" type="text"
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editServiceProviderForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Service Providerid</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateServiceProvider()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="itemCode" required="required"   
											ng-model="editServiceProvider.serviceProviderName" name="itemCode"
                              ...
                              <label class="col-md-4 control-label" for="textinput">
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editServiceProvider.serviceProviderDescription" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
					...
					<!-- 			<div class="form-group">
								<label class="col-md-2 control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editServiceProvider.blnStatus"
											class="form-control">
									</div>
								</div> -->
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/ServiceProvider.js"/>"></script>
