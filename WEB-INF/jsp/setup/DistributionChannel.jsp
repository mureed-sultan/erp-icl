...
<body>
	...
	<div class="wrapper" ng-controller="distributionChannelCtrl"
		data-ng-init="init()">
		<div class="box">
									...
									<div>
										<div class="form-group">
											<button id="addNewEntry" data-loading-text="Processing..."
												...
												data-target="#addDistributionChannelForm">
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<!-- <th class="column-title">DistributionChannel Code</th> -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Distribution Channel(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addDistributionChannelForm" tabindex="-1" role="dialog"
		aria-labelledby="addDistributionChannel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Distribution Channel</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addDistributionChannel()"
							...
							<!-- 	<div class="form-group">
									<label class="control-label" for="textinput">DistributionChannel 
										Code:<span class="required">*</span>
									</label>
									<div class="col-md-6">
										<input id="itemCode1" required="required" ng-minlength="4" ng-maxlength="30" 
											ng-model="newCfgDistributionChannelSetup.txtDistributionChannelCode" name="itemCode1" type="text"
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newCfgDistributionChannelSetup.txtCode" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
								...
								<label class="control-label" for="textinput">
										...
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newCfgDistributionChannelSetup.txtName" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editDistributionChannelForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Distribution Channel</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateDistributionChannel()"
							class="form-horizontal">
							<fieldset>
...
<div class="form-group">
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editDistributionChannel.txtCode" name="itemName"
                              ...
                              <label class="control-label" for="textinput">
										...
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editDistributionChannel.txtName" name="itemName"
											type="text" class="form-control input-md requiredField">
									</div>
								...
								<label class="control-label" for="textinput"
									...
									<input type="checkbox" id="empstat" name="empstat"
											 ng-model="editDistributionChannel.blnStatus"
											class="form-control">
									</div>
								</div>
								<div class="modal-footer">
	...
	<script src="<c:url value="/resources/js/Setup/DistributionChannel.js"/>"></script>
