										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Postpond</th>
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addEmployee()"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-12">
										<label class="control-label" for="textinput">Loan ID:<span class="required">*</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <label class="control-label" for="textinput">Amont Requested:<span
                                                class="required">*</span>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            <label class="control-label" for="textinput">Deduction per Month:<span
                                                class="required">*</span>
                                            </label> <input type="text" name="code"
                                                class="form-control input-md requiredField"
                                                ng-model="newHrEmployeeSetup.txtCnic">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label class="control-label" for="textinput">Total no. of Month:<span
                                                class="required">*</span>
                                            </label> <input type="text" name="code"
                                                class="form-control input-md requiredField"
                                                ng-model="newHrEmployeeSetup.txtCnic">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            <label class="control-label" for="textinput">Starting From Month:<span
                                                class="required">*</span>
                                            </label> <input type="text" name="code"
                                                class="form-control input-md requiredField"
                                                ng-model="newHrEmployeeSetup.txtCnic">
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <label class="control-label" for="textinput">Starting From Year:<span
                                                class="required">*</span>
                                            </label> <input type="text" name="code"
                                                class="form-control input-md requiredField"
                                                ng-model="newHrEmployeeSetup.txtCnic">
