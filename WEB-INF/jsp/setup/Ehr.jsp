...
<body>
	...
	<div class="wrapper" ng-controller="ehrCtrl"
		data-ng-init="init()">
		<div class="box">
	...
	<div class="modal fade" id="addEhrForm" tabindex="-1" role="dialog"
		aria-labelledby="addEhr">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add Ehr</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addEhr()"
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="itemCode1" required="required"  
											ng-model="ehrSetup.ehrName" name="itemCode1" type="text"
								...
								<label class="col-md-4 control-label" for="textinput">
									...
									<div class="col-md-6">
										<select class="form-control input-md selectpicker" ng-change=""
											ng-options="pp.serviceProviderid as pp.serviceProviderName for pp in lstServiceProvider"
											data-error="Please select Password Policy" required="required" data-live-search="true"
											ng-model="ehrSetup.serviceProvider.serviceProviderid">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
									</div>
								</div>
								 ...
								 <div class="form-group">
								<label class="col-md-4 control-label" for="textinput">
										Baa:<span class="required">*</span>
									</label>
									<div class="col-md-6">
										<select class="form-control input-md selectpicker" ng-change=""
											ng-options="pp.baaId as pp.baaName for pp in lstBaa"
											data-error="Please select Password Policy" required="required" data-live-search="true"
											ng-model="ehrSetup.baa.baaId">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
									</div>
								</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editEhrForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Ehr</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateEhr()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"   
											ng-model="editEhr.ehrName" name="itemCode"
								...
								<label class="col-md-4 control-label" for="textinput">
									...
									<div class="col-md-6">
										<select class="form-control input-md selectpicker" ng-change=""
											ng-options="pp.serviceProviderid as pp.serviceProviderName for pp in lstServiceProvider"
											data-error="Please select Password Policy" required="required" data-live-search="true"
											ng-model="editEhr.serviceProvider.serviceProviderid">
											<option ng-selected="selected" value="">--Select--</option>
										</select>
									</div>
								</div>
	...
	<script src="<c:url value="/resources/js/Setup/Ehr.js"/>"></script>
