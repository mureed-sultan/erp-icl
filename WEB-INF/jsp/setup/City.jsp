							...
							<fieldset>
								...
								<!-- Text input-->
                      			<div class="form-group">
									...
									<div class="col-md-8">				
									<label class="control-label" for="cityId">Country:<span class="required">*</span>
									</label>
									
									
									<select id="countryId" ng-model="newCfgCitySetup.cfgTblCountry.serCountryId"  required="required"
