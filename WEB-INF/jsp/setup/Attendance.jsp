...
<body>
	...
	<div class="wrapper" ng-controller="attendanceCtrl"
		data-ng-init="init()">
		<div class="box">
	  ...
	  <form class="form-inline" ng-submit="searchAttendance()" style="padding:left:20px;">
											...
											<div class="col-md-4">
												<input id="search_date" ng-model="dteDate22" name="search_date"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected Attendance(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addAttendanceForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<!-- <div class="modal-header">
					...
					<modalTitle>Add Attendance</modalTitle>
				</div> -->
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addAttendance()"
							class="form-horizontal">
							<fieldset>
							
                               <div class="form-group">
								<label class="col-md-4 control-label" for="textinput">Attendance
										:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemName1" required="required"   ng-minlength="4" ng-maxlength="50"
											ng-model="newHrAttendanceSetup.txtAttendanceDescription" name="itemName1" type="text"
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input id="st" required="required"
								ng-model="newTripsheet.timIncomingTime" name="st" type="text"
					...
					{{newTripsheet.timOutgoingTime}} ---{{newTripsheet.timIncomingTime}}
					<div class="form-group">
						...
						<div class="col-md-4">
							<input id="end" required="required"
								ng-model="newTripsheet.timOutgoingTime" name="end" type="text"
								class="form-control input-md requiredField timepicker">
						</div>
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editAttendanceForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateAttendance()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="Code" required="required"   readonly
											ng-model="editAttendance.employee.serEmployeeId" name="Code"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="Code" required="required"   readonly
											ng-model="editAttendance.employee.txtEmployeeName" name="Code"
											type="text" class="form-control input-md requiredField">
									</div>
									<!--  Text Input -->
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="Date" required="required"   readonly
											ng-model="editAttendance.dteDate | date" name="Date"
											type="text" class="form-control input-md requiredField">
									</div>
									<!--  Text Input -->
					...
					<div class="form-group">
							...
							Time:<span class="required">*</span>
									...
									<div class="col-md-4">
										<input id="itemCode" required="required"   readonly
											ng-model="editAttendance.dteDate | date" name="itemCode"
											type="text" class="form-control input-md requiredField">
									</div>
									<!--  Text Input -->
						...
						<div class="col-md-4">
							<input id="st2" required="required"
								ng-model="editAttendance.timIncomingTime | date : 'hh:mm a'" name="st2" type="text"
								class="form-control input-md requiredField timepicker">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
										<input id="endtime_date" required="required"  
											ng-model="editAttendance.timOutgoingTime | date" name="endtime_date"
											type="text" class="form-control input-md requiredField">
									</div>
						<div class="col-md-4">
							<input id="end2" required="required"
								ng-model="editAttendance.timOutgoingTime | date : 'hh:mm a'" name="end2" type="text"
								class="form-control input-md requiredField timepicker">
						</div>
	...
	<script src="<c:url value="/resources/js/Setup/Attendance.js"/>"></script>
