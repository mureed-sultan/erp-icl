...
<body>
	...
	<div class="wrapper" ng-controller="patientAccountCtrl"
		data-ng-init="init()">
		<div class="box">
									...
									<div>
										<div class="form-group">
											<button id="addNewEntry" data-loading-text="Processing..."
												...
												data-target="#addPatientAccountForm">
...
<div class="table-container" id="table-resp">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					selected PatientAccount(s)?</modalTitle>
				</div>
	...
	<div class="modal fade" id="addPatientAccountForm" tabindex="-1" role="dialog"
		aria-labelledby="addPatientAccount">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<modalTitle>Add PatientAccount</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addPatientAccount()"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="itemCode1" required="required"  
											ng-model="PatientAccountAuthSetup.account.firstName" name="itemCode1" type="text"
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="middleName" 
											ng-model="PatientAccountAuthSetup.account.middleName" name="middleName" type="text"
											class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="lastName"  required="required"  
											ng-model="PatientAccountAuthSetup.account.lastName" name="lastName" type="text"
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="txtContact"  maxlength="16"
											ng-model="PatientAccountAuthSetup.account.phoneNo" name="phoneNo" type="text"
											class="form-control input-md ">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<select id="mstat1" ng-model="PatientAccountAuthSetup.account.gender" 
									...
									<div class="col-md-6">
										<input id="email"  required="required"  
											ng-model="PatientAccountAuthSetup.account.email" name="email" type="email"
											class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="phoneNo"  required="required"  
											ng-model="PatientAccountAuthSetup.username" name="phoneNo" type="text"
											class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="passcode"  required="required"  
											ng-model="PatientAccountAuthSetup.password" name="passcode" type="password"
											class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="re_password"  required="required"  
...
<!-- 
								...
								<label class="col-md-4 control-label" for="textinput">
									...
									<div class="col-md-6">
										<input id="itemName1" required="required"   
											ng-model="PatientAccountAuthSetup.patientAccountDescription" name="itemName1" type="text"
											class="form-control input-md requiredField">
									</div>
								</div> -->
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editPatientAccountAuthForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit PatientAccount</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updatePatientAccount()"
							class="form-horizontal">
							<fieldset>
							...
							<!-- 	<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"   
											ng-model="editPatientAccountAuth.firstName" name="itemCode"
	                       ...
	                       <div class="form-group">
									...
									<div class="col-md-6">
										<input id="itemCode1" required="required"  
											ng-model="editPatientAccountAuth.account.firstName" name="itemCode1" type="text"
											class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="middleName"  
											ng-model="editPatientAccountAuth.account.middleName" name="middleName" type="text"
											class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="lastName"  required="required"
											ng-model="editPatientAccountAuth.account.lastName" name="lastName" type="text"
											class="form-control input-md ">
									</div>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="phoneNo"  maxlength="16"
											ng-model="editPatientAccountAuth.account.phoneNo" name="phoneNo" type="text"
											class="form-control input-md ">
									</div>
									...
									<div class="col-md-6">
										<select id="mstat1" ng-model="editPatientAccountAuth.account.gender" 
											name="mstat" class="form-control input-md requiredField "
											required="required" ng-change="" data-live-search="true">
											<option value="">--Select--</option>
											<option value="Male">Male</option>
									...
									<div class="col-md-6">
										<input id="email"   required="required"
											ng-model="editPatientAccountAuth.account.email" name="email" type="email"
											class="form-control input-md requiredField">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="txtContact"  required="required"
											ng-model="editPatientAccountAuth.username" name="txtContact" type="text"
											class="form-control input-md requiredField">
									</div>
	...
	<script src="<c:url value="/resources/js/Setup/PatientAccount.js"/>"></script>
