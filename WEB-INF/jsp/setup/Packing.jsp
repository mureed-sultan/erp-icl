...
<body>
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Packing Code</th>
													<th class="column-title">Packing Name</th>
							...
							<div class="form-group">
									...
									<select id="productCategoryId" ng-model="newCfgProductSetup.cfgTblProductCategory.serProductCategoryId" required
										...
										<div role="alert">
												...
												<span ng-show="addProductForm.productCategoryId.$error.required">Product Category is required.</span> 
											</span>
										</div>
									</div>
								...
								<div class="form-group">
									<label class="col-md-2 control-label" for="textinput">Packing
	...
	<script src="<c:url value="/resources/js/Setup/Packing.js"/>"></script>
