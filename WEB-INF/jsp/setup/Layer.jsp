...
<body>
	...
	<div class="wrapper" ng-controller="layerCtrl"
		data-ng-init="init()">
		<div class="box">
	...
	<div class="modal fade" id="addLayerForm" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Add Lehr</modalTitle>
				</div>
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addLayer()"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Lehr 
										:<span class="required">*</span>
									</label>
									<div class="col-md-4">
										<input id="itemCode1" required="required" 
											ng-model="newCfgLayerSetup.txtLayerCode" name="itemCode1" type="text"
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<textarea rows="6" cols="100" id="refNotes"
											ng-model="newCfgLayerSetup.txtDescription" name="refNotes" style="border: 1px solid"
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editLayerForm" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close" style="margin: 10px 10px 0 0;"
						onclick="clearAddGroupForm()">&times;</button>
					<modalTitle>Edit Lehr</modalTitle>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateLayer()"
							class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input id="itemCode" required="required"  
											ng-model="editLayer.txtLayerCode" name="itemCode"
								...
								<label class="col-md-2 control-label" for="textinput">Description:</label>
									...
									<div class="col-md-8">
										<textarea rows="6" cols="100" id="refNotes"
											ng-model="editLayer.txtDescription" name="refNotes" style="border: 1px solid"
											class="form-control input-md" placeholder="Enter Reference Notes"></textarea>
	...
	<script src="<c:url value="/resources/js/Setup/Layer.js"/>"></script>
