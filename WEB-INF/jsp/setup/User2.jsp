...
<body>
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									...
									<div class="alert alert-danger alert-dismissible"
										style="display: none;" user="alert" id="addErrorAlert">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>Error: </strong>&nbsp;<span id="errMsgText"></span>
									</div>
									<div class="alert alert-success alert-dismissible"
										style="display: none;" user="alert" id="successAlert">
										<button type="button" class="close" data-dismiss="alert">×</button>
										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">User Code</th>
	...
	<div class="modal fade" id="confirmModel" tabindex="-1" user="dialog">
	...
	<div class="modal fade" id="addUserForm" tabindex="-1" user="dialog"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addUser()"
								...
								<label class="col-md-4 control-label" for="textinput">User
									...
									<div class="col-md-4">
										<input id="itemName1" required="required"   
											ng-model="newCfgUserSetup.txtUserName" name="itemName1" type="text"
	...
	<!-- Edit Hostel Dialog Starts  -->
 	<div class="modal fade" id="editUserForm" tabindex="-1" user="dialog"
                              ...
                              <label class="col-md-4 control-label" for="textinput">User
									...
									<div class="col-md-8">
										<input id="itemName" required="required" ng-maxlength="50"
											ng-model="editUser.txtUserName" name="itemName"
	...
	<script src="<c:url value="/resources/js/Setup/User2.js"/>"></script>
