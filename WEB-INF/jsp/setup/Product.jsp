...
<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="modal-body">
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" name="addGroupForm" ng-submit="addProduct()"
							...
							<div class="form-group">
									<div class="col-md-6">							
									<label  control-label" for="productId">Product Category:<span class="required">*</span>
									</label>
								...
								<div class="form-group">
								<div class="col-md-6">
									<label class="control-label" for="textinput">Product
					...
					<div class="panel-body" id="mainPanel">
						<form id="addGroupForm" ng-submit="updateProduct()"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-6">				
									<label class=" control-label" for="productId">Product Category:<span class="required">*</span>
									</label>
									...
									<div class="col-md-6">
										<label class="control-label" for="textinput">Product
											Code:<span class="required">*</span>
										</label> <input id="edittxtProductCode" required="required"
											ng-model="editProduct.txtProductCode"
											name="edittxtProductCode" type="text"
											class="form-control input-md requiredField">
									</div>
									<div class="col-md-6">
										<label class="control-label" for="textinput">Product
											Name:<span class="required">*</span>
										</label> <input id="edittxtProductName" required="required"
											ng-model="editProduct.txtProductName"
											name="edittxtProductName" type="text"
											class="form-control input-md requiredField">
									</div>
								</div>
	...
	<script src="<c:url value="/resources/js/Setup/Product.js"/>"></script>
