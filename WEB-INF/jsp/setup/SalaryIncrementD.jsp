										...
										<table ng-table="user-table" id="data-table"
											...
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Earning</th>
													<th class="column-title">Old Amount </th>
													<th class="column-title">New Amount</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<modalTitle>Salary Increment</modalTitle>
				</div>
						...
						<form id="addGroupForm" name="addGroupForm" ng-submit="addEmployee()"
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<label class="control-label" for="textinput">Increment ID:<span class="required">*</span>
										</label> <select name="" id="" class="form-control input-md requiredField">
									  ...
									  <div class="form-group">
										<div class="col-md-12">
											...
											<label class="control-label" for="textinput">Date:<span
												class="required"></span>
											</label> <input type="date" name="code"
							...
							<div class="form-group">
									...
									<div class="col-md-12">
										...
										<select name="textinput" id="" class="form-control input-md requiredField">
											<option value="1">1</option>
										</select>
										</div>
							...
							<div class="form-group">
										...
										<label class="control-label" for="textinput"
											id="cname">Effective Date:<span class="required">*</span>
										</label>
									...
									<div class="form-group">
										<div class="col-md-6">
										<label class="control-label" for="textinput"
											id="cname">Increment %:<span class="required">*</span>
										</label>
										<input type="text" name="code"
										class="form-control input-md requiredField"
										ng-model="editEmployee.txtCnic">
									...
									<div class="col-md-6">
									<label class="control-label" for="textinput"
										id="cname">Increment Amount :<span class="required">*</span>
									</label>
									<input type="text" name="code"
									class="form-control input-md requiredField"
									ng-model="editEmployee.txtCnic">
									...
									<div class="form-group">
										<div class="col-md-12">
										<label class="control-label" for="textinput"
											id="cname">Reason on Increment:<span class="required">*</span>
										</label>
										<textarea class="class="form-control input-md requiredField""></textarea>
									</div>
									</div>	
